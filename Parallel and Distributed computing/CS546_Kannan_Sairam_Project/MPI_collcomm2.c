...
int main (int argc, char **argv) {
   ...
   const char* file1 = argc == 3 ? argv[1] : "sample/2_im1";
   const char* file2 = argc == 3 ? argv[2] : "sample/2_im2";
   ...
   MPI_Scatter( &A[0][0], chunk*N, MPI_COMPLEX, &A[chunk*my_rank][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
   MPI_Scatter( &B[0][0], chunk*N, MPI_COMPLEX, &B[chunk*my_rank][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
   ...
   MPI_Gather( &A[chunk*my_rank][0], chunk*N, MPI_COMPLEX, &A[0][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
   MPI_Gather( &B[chunk*my_rank][0], chunk*N, MPI_COMPLEX, &B[0][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
   ...
   MPI_Gather( &C[chunk*my_rank][0], chunk*N, MPI_COMPLEX, &C[0][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
   ...
   MPI_Scatter( &C[0][0], chunk*N, MPI_COMPLEX, &C[chunk*my_rank][0], chunk*N, MPI_COMPLEX, ROOT, MPI_COMM_WORLD );
